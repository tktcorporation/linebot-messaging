class Bot::LineusersController < ApplicationController
  ...
  def index
    ...
    @lineusers = @bot.lineusers.get_open_users.includes(:converted_lineuser, :quick_reply, :lineuser_status, :lastmessage).followed.order("messages.created_at desc").limit(50)
