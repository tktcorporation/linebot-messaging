...
var utils = __webpack_require__(/*! ./../utils */ 1);
var settle = __webpack_require__(/*! ./../core/settle */ 30);
...
var btoa = (typeof window !== 'undefined' && window.btoa && window.btoa.bind(window)) || __webpack_require__(/*! ./../helpers/btoa */ 35);
...
/* 24 */
/*!**********************************************!*\
  !*** ./app/javascript/packs/message_show.js ***!
  \**********************************************/
/*! no exports provided */
/*! all exports used */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue_dist_vue_esm_js__ = __webpack_require__(/*! vue/dist/vue.esm.js */ 5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_axios__ = __webpack_require__(/*! axios */ 25);
...
var app = new __WEBPACK_IMPORTED_MODULE_0_vue_dist_vue_esm_js__["a" /* default */]({
  ...
  methods: {
    fetchTasks: function fetchTasks() {
      ...
      __WEBPACK_IMPORTED_MODULE_1_axios___default.a.defaults.headers['X-CSRF-TOKEN'] = $('meta[name=csrf-token]').attr('content');
      __WEBPACK_IMPORTED_MODULE_1_axios___default.a.get('/api/bot/1/messages/13').then(function (response) {
        _this.lineuser.name = response.data.lineuser.name;
        _this.lineuser.pictureUrl = response.data.lineuser.pictureUrl;
        for (var i = 0; i < response.data.lineuser['messages'].length; i++) {
          _this.lineuser['messages'].push(response.data.lineuser['messages'][i]);
        }
      }, function (error) {
        console.log(error);
      });
    },
    displayFinishedTasks: function displayFinishedTasks() {
    ...
    createTask: function createTask() {
      ...
      __WEBPACK_IMPORTED_MODULE_1_axios___default.a.post('/api/tasks', { task: { name: this.newTask } }).then(function (response) {
        _this2.tasks.unshift(response.data.task);
        _this2.newTask = '';
      }, function (error) {
        console.log(error);
      });
    },
    doneTask: function doneTask(task_id) {
      var _this3 = this;

      __WEBPACK_IMPORTED_MODULE_1_axios___default.a.put('/api/tasks/' + task_id, { task: { is_done: 1 } }).then(function (response) {
        _this3.moveFinishedTask(task_id);
      }, function (error) {
        console.log(error);
      });
    },
    moveFinishedTask: function moveFinishedTask(task_id) {
...
/***/ })
/******/ ]);
//# sourceMappingURL=message_show-29e1fa4a87a8f01a32ce.js.map