...
var app = new __WEBPACK_IMPORTED_MODULE_0_vue_dist_vue_esm_js__["a" /* default */]({
  ...
  methods: {
    fetchMessages: function fetchMessages() {
      ...
      __WEBPACK_IMPORTED_MODULE_1_axios___default.a.get('/api/bot/' + this.bot_id + '/messages/' + this.lineuser_id).then(function (response) {
        console.log(response.data.lineuser.messages.slice(-1)[0].id);
        if (response.data.lineuser.messages.slice(-1)[0].id == _this2.last_message_id) {
          return;
        }
        _this2.last_message_id = response.data.lineuser.messages.slice(-1)[0].id;
        _this2.lineuser.name = response.data.lineuser.name;
        _this2.lineuser.pictureUrl = response.data.lineuser.pictureUrl;
        _this2.lineuser.messages = [];
        for (var i = 0; i < response.data.lineuser.messages.length; i++) {
          _this2.lineuser.messages.push(response.data.lineuser.messages[i]);
        }
      }, function (error) {
        console.log(error);
      });
    },
    set_param: function set_param() {
...
/***/ })
/******/ ]);
//# sourceMappingURL=message_show-be0dcea34fc284b445ef.js.map